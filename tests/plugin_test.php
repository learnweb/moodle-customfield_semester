...
/**
 * Functional test for customfield_semester
 *
 * @package    customfield_semester
 * @covers     \customfield_semester\data_controller
 * @covers     \customfield_semester\field_controller
 * @copyright  2025 Thomas Niedermaier
...
final class plugin_test extends \advanced_testcase {
    ...
    public function setUp(): void {
        ...
        $this->cfields[1] = $this->get_generator()->create_field(
            ['categoryid' => $this->cfcat->get('id'), 'shortname' => 'myfield1', 'type' => 'semester',
                'configdata' => [
    ...
    public function test_initialize(): void {
        ...
        $f = \core_customfield\field_controller::create(0, (object)['type' => 'semester'], $this->cfcat);
        $this->assertTrue($f instanceof field_controller);
